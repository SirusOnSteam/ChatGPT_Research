...
import csv
from Page11 import Page11  # Ensure Page7 is properly implemented
...
class Page10(tk.Frame):
    ...
    def setup_ui(self):
        titleLabel = tk.Label(self, text='NASA TLX Survey for Challenge 3: ', font=("Helvetica", 14, "bold"))
    ...
    def submit_survey_answers(self):
        if messagebox.askyesno("Confirm Submission", "Are you sure you want to submit your responses?"):
            ...
            self.controller.show_page(Page11)
        else:
            return
    ...
    def save_data_to_csv(self, data_dict):
        ...
        with open(filename, 'a', newline='') as csvfile:
            ...
            for question, answer in data_dict.items():
                writer.writerow(["PCH 3 " + question, "{:.2f}".format(answer)])  # Write question and answer in two columns

if __name__ == "__main__":
    root = tk.Tk()
    root.title("Survey Example")
    page = Page10(root, None)
